...
**Requirements:** One of [Claude Code](https://docs.anthropic.com/en/docs/claude-code) or [Pi](https://pi.dev), [Git](https://git-scm.com/), [Bun](https://bun.sh/) v1.0+, [Node.js](https://nodejs.org/) (Windows only)
